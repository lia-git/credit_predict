...
if __name__ == '__main__':
    sql = 'select * from application_train a join bureau_dis b on a.SK_ID_CURR = b.SK_ID_CURR limit'
    # data = load_train()
    data = load_mysql(sql)
    sql_test = '''
               ...
               from  
               application_test a join bureau_dis b on a.SK_ID_CURR = b.SK_ID_CURR limit 
                '''
    # data = load_train()
