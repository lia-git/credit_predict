...
params = params {'booster': 'gbtree', 'objective': 'binary:logistic', 'gamma': 0.01, 'max_depth': 3, 'lambda': 0.5, 'subsample': 0.4, 'colsample_bytree': 0.7, 'min_child_weight': 1, 'silent': 0, 'eta': 0.41, 'seed': 1000, 'tree_method': 'gpu_hist'}
